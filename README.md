...
1. Download **`drumford-x-v0.1.1-win-x64.zip`** from the [latest release](https://github.com/FordNet-AI/drumford-x/releases/latest)
...
1. Download **`drumford-x-v0.1.1-android.apk`** from the [latest release](https://github.com/FordNet-AI/drumford-x/releases/latest)
